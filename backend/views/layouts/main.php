...
<div class="wrap">
    ...
    $menuItems = [
        ...
        ['label' => 'Users Settings', 'url' => ['/user-settings/index']],
        ['label' => 'Domains', 'url' => ['/domains/index']],
        ['label' => 'Settings', 'url' => ['/settings/index']],
        ['label' => 'AdminSettings', 'url' => ['/admin-settings/index']],
        ['label' => 'Transactions', 'url' => ['/transactions/index']],
        ['label' => 'Balances', 'url' => ['/balances/index']],
